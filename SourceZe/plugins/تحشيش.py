...
#كـتابة المـلف وتعديل.    :   مرسليو.   اخمط وسمي روحك مطور فرخي 😂
...
async def permalink(mention):
    await edit_or_reply(mention, f"سماحة مرسليو علي مطور سورس  تايجر  @PP_KU")
    ...
    if event.reply_to and event.sender_id in UP_UO:
       ...
       if owner_id == mody.uid:
           if event.message.message == "منصب؟":
               ...
               await event.reply("** مرسليو @XIX_A تاج راسي ❤️**")
