# Source-Tiger 
# Copyright (C) 2022 Source-Tiger. All Rights Reserved
#
import asyncio
import requests
import logging
...
async def supc(event):  # Source-Tiger 
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await mody.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل@XIX_A لحل المشكلة\n{reqt}**")
