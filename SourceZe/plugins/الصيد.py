...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس تايجر  : 
    ...
    try:
        ch = await mody(
            functions.channels.CreateChannelRequest(
                title="TIGER HUNTER - صيد تايجر ",
                about="This channel to hunt username by - @PP_KU  ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/PP_KU /2",
                    caption="🔱 tiger the best 🔱\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @PP_KU  - @XIX_A ❳ ".format(
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await mody(
                functions.channels.CreateChannelRequest(
                    title="TIGER HUNTER - تثبيت تايجر ",
                    about="This channel to hunt username by - @PP_KU  ",
                )
            )
            ch = ch.updates[1].channel_id
