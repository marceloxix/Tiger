#    جميع الحقوق لمطوري سورس تايجر حصريا لهم فقط
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/XIX_A"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب تايجر   🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/XIX_A")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/PP_KU")],
                [Button.url("كروب المساعدة ❓", "https://t.me/PP_UF")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @PP_KU", alert=True)




@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"rozname"))) 
async def settings(event):  #    قـسـم  الزغرفـة تايجر 
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
