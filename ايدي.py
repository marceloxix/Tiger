...
# code by t.me/XIX_A
ar_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت تايجر "
arM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
arF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐓𝐈𝐆𝐄𝐑  ─┄─┄─┄─⋆"
ar_dev = (7131944336)
ze_dev = (7131944336)
ze = (7131944336)
...
# الـرتب الوهميـه & البريميـوم كتـابـة الكـود -  مرسليو @XIX_A
    if user_id in ze: # code by t.me/XIX_A
    ...
    if mody == True or user_id in ze: # code by t.me/XIX_A
        caption += f"<b>{arM}الحسـاب ⇠  بـريميـوم 🌟</b>\n"
    caption += f"<b>{arM}الصـور    ⇠ </b> {replied_user_profile_photos_count}\n"
    if user_id != (await event.client.get_me()).id: # code by t.me/XIX_A
